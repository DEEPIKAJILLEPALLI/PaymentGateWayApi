    ...
    public class HomeController : ApiController
    {
        ...
        public string GetFormToken(decimal amount)
        {
            ...
            ApiOperationBase<ANetApiRequest, ANetApiResponse>.MerchantAuthentication = new merchantAuthenticationType()
            {
                ...
                Item = "22KP578wZcp5xW4h"
            };

            var customerProfile = new customerProfilePaymentType();
            customerProfile.customerProfileId = "1927810742";
            customerProfile.createProfile = true; //not needed
            ...
            //{
            //    settingName = settingNameEnum.hostedPaymentReturnOptions.ToString(),
            //    settingValue = @"{""showReceipt"": true, ""url"": ""http://localhost:4200/summary"", 
            ...
            settings.Add(new settingType()
            {
                ...
                settingValue = @"{ ""url"" : ""http://localhost:4200/IFrameCommunicator.html"" }"
            });
        ...
        public string GetEditPaymentToken()
        {
            ...
            settings.Add(new settingType()
            {
                ...
                settingValue = "http://localhost:4200/IFrameCommunicator.html"
            });
